...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'example', // 主题， 支持 ['next','hexo',"fukasawa','medium','example'] @see https://preview.tangly1024.com
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'D', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Just Some Notes', // 作者简介
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,email', // 分享的服務，按顺序显示,逗号隔开
